...
CREATE TABLE tblBin (
    ...
    CapacityWeight DECIMAL(18,3) DEFAULT 1000.000,
    CapacityVolume DECIMAL(18,3) DEFAULT 500.000,
    OccupiedWeight DECIMAL(18,3) DEFAULT 0.000,
    OccupiedVolume DECIMAL(18,3) DEFAULT 0.000,
    IsActive TINYINT(1) DEFAULT 1 NOT NULL,
...
CREATE TABLE tblItem (
    ...
    Volume DECIMAL(18,3) DEFAULT 0.000,
    UnitCost DECIMAL(18,3) DEFAULT 0.000,
    SellingPrice DECIMAL(18,3) DEFAULT 0.000,
    MinStock DECIMAL(18,3) DEFAULT 0.000,
    MaxStock DECIMAL(18,3) DEFAULT 999999.000,
    PurchPrice DECIMAL(18,3) DEFAULT 0.000,
    PurchDiscount DECIMAL(18,3) DEFAULT 0.000,
    AltSalePrice DECIMAL(18,3) DEFAULT 0.000,
    AltPurchPrice DECIMAL(18,3) DEFAULT 0.000,
    MRP DECIMAL(18,3) DEFAULT 0.000,
    SaleDiscount DECIMAL(18,3) DEFAULT 0.000,
...
CREATE TABLE tblGRNDetail (
    ...
    AcceptedQty DECIMAL(18,3) DEFAULT 0.000 NOT NULL,
    RejectedQty DECIMAL(18,3) DEFAULT 0.000 NOT NULL,
    PutawayQty DECIMAL(18,3) DEFAULT 0.000 NOT NULL,
...
CREATE TABLE tblInventory (
    ...
    ItemId INT NOT NULL,
    BatchId INT DEFAULT NULL,
    Quantity DECIMAL(18,3) DEFAULT 0.000 NOT NULL,
    ReservedQty DECIMAL(18,3) DEFAULT 0.000 NOT NULL,
    UpdatedAt DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE tblSalesOrderDetail (
    ...
    OrderQty DECIMAL(18,3) NOT NULL,
    ReservedQty DECIMAL(18,3) DEFAULT 0.000 NOT NULL,
    PickedQty DECIMAL(18,3) DEFAULT 0.000 NOT NULL,
    ShippedQty DECIMAL(18,3) DEFAULT 0.000 NOT NULL,
    UOM VARCHAR(20) NOT NULL,
    UnitPrice DECIMAL(18,3) DEFAULT 0.000,
...
CREATE TABLE tblCycleCountDetail (
    ...
    ItemId INT NOT NULL,
    BatchId INT DEFAULT NULL,
    SystemQty DECIMAL(18,3) NOT NULL DEFAULT 0.000,
    CountedQty DECIMAL(18,3) DEFAULT NULL,
    Variance DECIMAL(18,3) GENERATED ALWAYS AS (CountedQty - SystemQty) STORED,
    Status VARCHAR(20) DEFAULT 'PENDING' NOT NULL,
    Notes VARCHAR(255) DEFAULT NULL,
...
CREATE TABLE tblStockAlertLog (
    ...
    ThresholdValue DECIMAL(18,3) NOT NULL,
...
BEGIN
    DECLARE v_TotalQty DECIMAL(18,3);
    DECLARE v_TotalReserved DECIMAL(18,3);
...
BEGIN
    DECLARE v_POId INT;
    DECLARE v_TotalOrdered DECIMAL(18,3);
    DECLARE v_TotalReceived DECIMAL(18,3);
...
BEGIN
    ...
    DECLARE v_ItemWeight DECIMAL(18,3);
    DECLARE v_ItemVolume DECIMAL(18,3);
    DECLARE v_TotalAccepted DECIMAL(18,3);
    DECLARE v_TotalPutaway DECIMAL(18,3);
